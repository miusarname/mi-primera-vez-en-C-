# Repositorio de Aprendizaje de Programación en C#
...
### 1. [Introduction to C#](/IntroductionCS)
...
### 2. [Object Oriented Programming (OOP)](/POO)
...
### 3. [Practical Examples](/PracticalExamples)
...
- [Official C# Documentation](https://docs.microsoft.com/es-es/dotnet/csharp/)
- C# Fundamentals](https://www.pluralsight.com/courses/csharp-fundamentals-with-visual-studio)
- [Object-Oriented Programming in C#](https://www.c-sharpcorner.com/technologies/object-oriented-programming-oop)
...
### 1. [C# 入門](/IntroductionCS)

このセクションには、C#の基本的な構文や構造に慣れるための入門資料があります。

Program.cs

### 2. [オブジェクト指向プログラミング(OOP)](/POO)
